...
async def startup_db_migration():
    ...
    try:
        ...
        # 5. Fix PostgreSQL identity columns for challenges
        try:
            ...
            db.commit()
            print("DEBUG: PostgreSQL identity fix applied for challenges")
        except Exception:
            db.rollback() # Ignore if already exists or not supported
