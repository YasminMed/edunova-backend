...
class MarksPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> subjects = [
      {
        'name': l10n?.translate('math') ?? 'Mathematics',
        'mark': 92,
        'grade': 'A',
      ...
      {
        'name': l10n?.translate('science') ?? 'Science',
        'mark': 88,
        'grade': 'A-',
      ...
      {
        'name': l10n?.translate('programming') ?? 'Programming',
        'mark': 95,
        'grade': 'A+',
      ...
      {
        'name': l10n?.translate('english_subject') ?? 'English Language',
        'mark': 84,
        'grade': 'B+',
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                "${subject['mark']}%",
                style: TextDesign.h3.copyWith(color: subject['color']),
              ),
            ],
          ),
